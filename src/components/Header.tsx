...
export const Header = () => {
    ...
    return (
        <header className="h-16 fixed top-0 right-0 left-0 md:left-64 z-30 bg-background/80 backdrop-blur-md border-b border-border px-4 sm:px-6 flex items-center justify-between pl-16 md:pl-6">
            ...
            <div className="flex items-center gap-4">
                <button className="w-10 h-10 rounded-full bg-secondary flex items-center justify-center text-muted-foreground hover:text-foreground hover:bg-secondary/80 transition-colors relative">
